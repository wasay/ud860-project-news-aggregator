...
APP.Main = function () {
    ...
    function showStory(id) {
        ...
        function animate() {
            ...
            if (left === null) left = storyDetailsPosition.left;
            ...
            if (Math.abs(left) > 0.5)
                ...
                requestAnimationFrame(animate);else left = 0;
    ...
    main.addEventListener('scroll', function () {
        ...
        if (main.scrollTop > 70) document.body.classList.add('raised');else document.body.classList.remove('raised');
